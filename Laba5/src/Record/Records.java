...
public class Records extends javax.swing.JDialog {
    ...
    public Records(java.awt.Frame parent, boolean modal, Connection c) throws SQLException {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        connection = c;
        currentIdDoctor = RecordModel.selectRecords(c).size()+1;
        model = new RecordModel(connection);
    ...
    private void jButtonADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonADDActionPerformed
        ...
        try {
            NewRecord nd = new NewRecord((Frame) this.getParent(), true, connection,currentIdDoctor);
            nd.setVisible(true);
            model.updateData();
            currentIdDoctor++;
    ...
    private void jButtonALTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonALTERActionPerformed
        try { if (jTable1.getSelectedRow() >= 0) {
            NewRecord nd = new NewRecord((Frame) this.getParent(), true,
