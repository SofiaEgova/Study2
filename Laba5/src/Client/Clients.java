...
public class Clients extends javax.swing.JDialog {
    ...
    public Clients(java.awt.Frame parent, boolean modal, Connection c) throws SQLException {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        connection = c;
        currentIdClient = ClientModel.selectClients(c).size()+1;
    ...
    private void jButtonADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonADDActionPerformed
        ...
        try {
            NewClient nc = new NewClient((Frame) this.getParent(), true, connection,currentIdClient);
            nc.setVisible(true);
            model.updateData();
            currentIdClient++;
    ...
    private void jButtonALTERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonALTERActionPerformed
        try { if (jTable1.getSelectedRow() >= 0) {
            NewClient np = new NewClient((Frame) this.getParent(), true,
